    ...
    if (ids.contains('ciprofloxacin-oral') && ciproMinerals) {
      alerts.add(
        const PlanAlert(
          ...
          message:
              'الحديد والكالسيوم والمغنيسيوم والزنك ومضادات الحموضة/المنتجات المعدنية قد تقلل امتصاص ciprofloxacin. استخدم فاصل المنتج الموثق ولا تضعها في نفس وقت الجرعة.',
          isCritical: true,
        ),
      );
    }
