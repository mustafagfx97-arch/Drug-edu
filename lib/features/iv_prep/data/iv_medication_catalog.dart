...
const ivMedicationCatalog = <IvCatalogEntry>[
  ...
  IvCatalogEntry(name: 'Midazolam', population: 'PICU', category: 'Sedation & analgesia', structured: true),
  IvCatalogEntry(name: 'Dexmedetomidine', population: 'PICU', category: 'Sedation & analgesia', structured: true),
  IvCatalogEntry(name: 'Ketamine', population: 'PICU', category: 'Sedation & analgesia', structured: true),
  IvCatalogEntry(name: 'Regular insulin infusion', population: 'PICU', category: 'Electrolytes & metabolic', structured: true),
  IvCatalogEntry(name: 'Heparin', population: 'PICU', category: 'Anticoagulation & hemostasis', structured: true),
];
