...
const expandedMedications17 = <Medication>[
  ...
  Medication(
    ...
    patient: PatientCounselingData(
      ...
      missedDoseAr:
          'في الأسبوع الثاني أو الثالث: إذا تأخر تغيير اللصقة يومًا أو يومين ضعي لصقة جديدة واستمري على يوم التغيير المعتاد دون backup؛ إذا تجاوز التأخر يومين ابدئي دورة جديدة واستخدمي backup لمدة 7 أيام.',
      storageAr:
